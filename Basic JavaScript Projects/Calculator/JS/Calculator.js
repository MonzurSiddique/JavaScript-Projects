...
function Input_Digit(digit) {
    ...
    //Checks if Wait_Second_Operand variable is true aand sets
    //Display value to key that was clicked on
...
function Handle_Operator(Next_Operator) {
    ...
    //Then updates the operator and exit the function
...
//This functions updates the calculator screen with the contents of Display Value
